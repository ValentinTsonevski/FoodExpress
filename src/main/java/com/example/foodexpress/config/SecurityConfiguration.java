    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http.
                ...
                // the URL-s below are available for all users - logged in and anonymous
                        ...
                        "/offers/all", "/working-time", "/cart", "/cart/addOffer", "/cart/addOffer/{id}", "/cart/removeOffer/{id}", "/cart/buy").permitAll().

                requestMatchers("/offers/add", "/offers/delete/{id}", "/offers/{id}/edit", "/admin/users/all", "/admin/users/make-admin",
                        "/api/users/delete/{id}", "/api/users").hasRole("ADMIN").
